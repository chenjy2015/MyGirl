package app.originality.com.originality.modules.photo.utils;
...
public class Utils {
    ...
    public final static String[] imageUrls = new String[]{
            ...
            "http://img4.duitang.com/uploads/blog/201407/07/20140707113856_WPf3R.thumb.jpeg",
    ...
    static {
        friends.add(new Friend(imageUrls[0], R.drawable.anastasia, "ANASTASIA", R.color.sienna, "Sport", "Literature", "Music", "Art", "Technology"));
        friends.add(new Friend(imageUrls[1], R.drawable.irene, "IRENE", R.color.saffron, "Travelling", "Flights", "Books", "Painting", "Design"));
        friends.add(new Friend(imageUrls[2], R.drawable.kate, "KATE", R.color.green, "Sales", "Pets", "Skiing", "Hairstyles", "Сoffee"));
        friends.add(new Friend(imageUrls[3], R.drawable.paul, "PAUL", R.color.pink, "Android", "Development", "Design", "Wearables", "Pets"));
        friends.add(new Friend(imageUrls[4], R.drawable.daria, "DARIA", R.color.orange, "Design", "Fitness", "Healthcare", "UI/UX", "Chatting"));
        friends.add(new Friend(imageUrls[5], R.drawable.kirill, "KIRILL", R.color.saffron, "Development", "Android", "Healthcare", "Sport", "Rock Music"));
        friends.add(new Friend(imageUrls[6], R.drawable.julia, "JULIA", R.color.green, "Cinema", "Music", "Tatoo", "Animals", "Management"));
        friends.add(new Friend(imageUrls[7], R.drawable.yalantis, "YALANTIS", R.color.purple, "Android", "IOS", "Application", "Development", "Company"));
    }
}
